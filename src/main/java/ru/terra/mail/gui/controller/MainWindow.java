...
public class MainWindow extends AbstractUIController {
	...
	private void setColums() {
		...
		colDate.setCellFactory(
				new Callback<TableColumn<MessagesTableItem, Date>, TableCell<MessagesTableItem, Date>>() {
					@Override
					public TableCell<MessagesTableItem, Date> call(TableColumn<MessagesTableItem, Date> param) {
		...
		colDate.setComparator(new Comparator<Date>() {
			@Override
